        ...
        <ul class="sidebar-menu">
            ...
            <li class="dropdown <?php echo e(request()->is('barcode/create') || request()->is('inventaris') ? 'active' : ''); ?>">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li class="<?php echo e(request()->is('importExoportView') ? 'active' : ''); ?>"> <a href="<?php echo e(route('importExportView')); ?>"
...
<?php /**PATH /home/u0453371/public_html/inventaris/resources/views/layouts/sidebar.blade.php ENDPATH**/ ?>