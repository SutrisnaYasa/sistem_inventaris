...
$(function () {
  ...
  $("[data-toggle='sidebar']").click(function () {
    ...
    if (w.outerWidth() > 1024 && body.hasClass('hide-sidebar-always')) {
      body.removeClass('search-show search-gone');
      if (body.hasClass('sidebar-gone-always')) {
        body.removeClass('sidebar-gone-always');
        body.addClass('sidebar-show');
      } else {
        body.addClass('sidebar-gone-always');
        body.removeClass('sidebar-show');
      }

      update_sidebar_nicescroll();
    } else if (w.outerWidth() <= 1024) {
      body.removeClass('search-show search-gone');
